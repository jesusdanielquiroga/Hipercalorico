 ...
 */
 function editarRegistro(llaveRegistro) {
    ...
    $.ajax({
        ...
        url: "http://localhost:8081/api/user/" + llaveRegistro,
...
function editarRespuesta(items) {
    ...
    $("#idEdit").val(items.id);
    $("#iduserEdit").val(items.identification);
    $("#usernameEdit").val(items.name);
    $("#addressUserEdit").val(items.address);
    $("#cellPhoneEdit").val(items.cellPhone);
    $("#emailUserEdit").val(items.email);
    $("#passwordEdit").val(items.password);
    $("#zonaUserEdit").val(items.zone);
    $("#typeUserEdit").val(items.type);
...
function actualizar() {
    ...
    let datos = {
        id: $("#idEdit").val(),
        identification: $("#iduserEdit").val(),
        name: $("#usernameEdit").val(),
        address: $("#addressUserEdit").val(),
        cellPhone: $("#cellPhoneEdit").val(),
        email: $("#emailUserEdit").val(),
        password: $("#passwordEdit").val(),
        zone: $("#zonaUserEdit").val(),
        type: $("#typeUserEdit").val()
    }
